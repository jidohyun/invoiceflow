defmodule AutoMyInvoice.ExtractionTest do
  ...
  describe "save_result/4" do
    ...
    test "broadcasts extraction_completed via PubSub" do
      ...
      topic = AutoMyInvoice.PubSubTopics.extraction_completed(job.id)
      Phoenix.PubSub.subscribe(AutoMyInvoice.PubSub, topic)
